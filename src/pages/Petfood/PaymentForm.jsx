...
const PaymentForm = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-5xl w-full grid md:grid-cols-2 overflow-hidden z-10">
          ...
          >
            ...
            <div className="p-3 bg-yellow-50 border rounded-xl text-sm">
              {formData.paymentMethod === "Bkash" &&
                "Send to 01754862489 (Bkash)"}

              {formData.paymentMethod === "Nogod" &&
                "Send to 01962584371 (Nogod)"}

              {formData.paymentMethod === "Rocket" &&
                "Send to 01854211690 (Rocket)"}
            </div>
